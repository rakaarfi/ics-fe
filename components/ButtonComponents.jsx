...
export const ButtonSubmit = ({ onClick }) => (
    <button
        type="submit"
        onClick={onClick}
        className="text-white bg-[#4F4789] hover:bg-[#736BB3] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5"
    >
        Submit
    </button>
);
...
export const ButtonSave = ({ onClick }) => (
    <button
        type="submit"
        onClick={onClick}
        className="bg-[#4F4789] hover:bg-[#7a70c4] text-white font-bold py-1 px-3 rounded"
    >
        Save
    </button>
);
...
export const CancelButton = ({ onClick }) => (
    <button
        onClick={onClick}
        className="bg-[#685f60] hover:bg-[#c1aeb0] text-white font-bold py-1 px-3 rounded"
    >
        Cancel
    </button>
)